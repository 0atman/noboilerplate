...
todo
- [x] re-take author example screenshot
- [x] take screenshot of result slide
- [x] tighten up the speed, too slow
- [ ] remove pause after 'is this code correct'
- [x] "how can we hope" - don't go back to the cover page, then hit the SO survey
- [x] free stuff slide goes too fast, trim down
